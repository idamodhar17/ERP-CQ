...
export default function StaffSalary() {
    ...
    return (
        <>
            <section>
                <div className="">
                    <h1 className="text-2xl">Staff Salary</h1>
                    ...
                    <div className="mt-10 shadow-lg p-4">
                        <div className="grid grid-cols-3 items-center">
                            ...
                            <div className="flex items-center justify-self-center gap-6 border-2 border-blue-300 px-10 py-2 rounded-2xl">
                                ...
                                <button className="text-blue-500 hover:text-blue-700 border-x-2 border-x-blue-400 px-3"><Sheet /></button>
                                <button className="text-blue-500 hover:text-blue-700"><FileText /></button>
                            </div>
                        </div>
